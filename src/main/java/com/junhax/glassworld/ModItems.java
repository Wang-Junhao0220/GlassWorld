...
public class ModItems {
    ...
    public static final Item INSTANT_HEALTH_APPLE = register(new Item(new FabricItemSettings().fireproof().food(new FoodComponent.Builder()
            ...
            .statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.HASTE, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 10 * 60 * 60 * 20, 20), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.HERO_OF_THE_VILLAGE, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 10 * 60 * 60 * 20, 99), 1.0F)
            .statusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 10 * 60 * 60 * 20, 99), 1.0F)
