 ...
 */
package com.junhax.glassworld.block.glassslabs;
...
public final class IronGlassSlabBlock extends SlabBlock
{
	public IronGlassSlabBlock(Settings settings)
	{
		super(settings);
	}
...
//		if(stateFrom.getBlock() == ModBlocks.IRON_GLASS_STAIRS)
