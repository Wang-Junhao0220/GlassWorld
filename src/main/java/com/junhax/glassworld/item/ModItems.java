...
import com.junhax.glassworld.material.AncientGlassArmorMaterial;
import com.junhax.glassworld.material.AncientGlassMaterial;
import com.junhax.glassworld.material.DiamondGlassArmorMaterial;
import com.junhax.glassworld.material.DiamondGlassMaterial;
...
public class ModItems {
    ...
    public static final Item INSTANT_HEALTH_APPLE = register(new Item(new FabricItemSettings().fireproof().food(new FoodComponent.Builder().alwaysEdible().hunger(5).saturationModifier(2F).statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 2 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.ABSORPTION, 10 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 40 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.HEALTH_BOOST, 10 * 60 * 20, 30), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.HASTE, 10 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 60 * 20, 1), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.NIGHT_VISION, 20 * 60 * 20, 10), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 2 * 60 * 20, 6), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 5 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.STRENGTH, 5 * 60 * 20, 5), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.HERO_OF_THE_VILLAGE, 40 * 60 * 20, 10), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.WATER_BREATHING, 10 * 60 * 20, 15), 1.0F).statusEffect(new StatusEffectInstance(StatusEffects.INVISIBILITY, 10 * 60 * 20, 255), 1.0F).statusEffect(new StatusEffectInstance(ModEffects.EXP, 20 * 20, 3), 0.4F).build())), ItemId.INSTANT_HEALTH_APPLE);


    private static final ItemGroup ITEM_GROUP = FabricItemGroup.builder().icon(() -> new ItemStack(DIAMOND_GLASS)).displayName(Text.translatable("itemGroup.glassworld.more_glass")).entries((context, entries) -> {
        // Blocks
...
//        entries.add(OAK_GLASS_DOOR);
        ...
        entries.add(DIAMOND_GLASS_STAIRS);
        entries.add(DIAMOND_GLASS_SLAB);
        entries.add(DIAMOND_GLASS_DOOR);
        entries.add(SOFT_DIAMOND_GLASS);
        entries.add(ANCIENT_GLASS);
        entries.add(ANCIENT_GLASS_STAIRS);
        entries.add(ANCIENT_GLASS_SLAB);
        entries.add(ANCIENT_GLASS_DOOR);
        entries.add(SOFT_ANCIENT_GLASS);
        entries.add(GOLDEN_GLASS);
        entries.add(GOLDEN_GLASS_STAIRS);
        entries.add(GOLDEN_GLASS_SLAB);
        entries.add(GOLDEN_GLASS_DOOR);
        entries.add(SOFT_GOLDEN_GLASS);
        entries.add(REDSTONE_GLASS);
        entries.add(REDSTONE_GLASS_STAIRS);
        entries.add(REDSTONE_GLASS_SLAB);
        entries.add(REDSTONE_GLASS_DOOR);
        ...
        entries.add(EMERALD_GLASS_STAIRS);
        entries.add(EMERALD_GLASS_SLAB);
        entries.add(EMERALD_GLASS_DOOR);
        entries.add(SOFT_EMERALD_GLASS);
        entries.add(COPPER_GLASS);
        entries.add(COPPER_GLASS_STAIRS);
    ...
    public static void initialize() {
        ...
        ItemGroupEvents.modifyEntriesEvent(ItemGroups.FOOD_AND_DRINK).register((itemGroup) -> itemGroup.add(ModItems.INSTANT_HEALTH_APPLE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_SHOVEL));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_PICKAXE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_AXE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_HOE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_SWORD));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_SHOVEL));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_PICKAXE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_AXE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.TOOLS).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_HOE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_SWORD));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_HELMET));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_CHESTPLATE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_LEGGINGS));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.DIAMOND_GLASS_BOOTS));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_HELMET));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_CHESTPLATE));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_LEGGINGS));

        ItemGroupEvents.modifyEntriesEvent(ItemGroups.COMBAT).register((itemGroup) -> itemGroup.add(ModItems.ANCIENT_GLASS_BOOTS));
    }
}